...
class Heart(Human): #Ingeritates everything from Human because they a similar
    def __init__(self,screen,g_settings):
        super().__init__(screen,g_settings)
        self.sound = pygame.mixer.Sound('sounds/heal.wav') #New sound

        self.image = pygame.image.load('images/heart1.png') #New image
